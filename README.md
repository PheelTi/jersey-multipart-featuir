...
[![CircleCI](https://circleci.com/gh/archytas-it/jersey-multipart-upload-core-feature.svg?style=shield)](https://circleci.com/gh/archytas-it/jersey-multipart-upload-core-feature)
...
| requestSizeLimitAction | throw a `413 Entity too large` exception | Action to take if the request size exceeds the defined value|
...
This component **SHOULD NOT** store temporarly the whole part contents in memory or in the file system,
...
> An `AmazonS3BodyPart` and its provider could be implemented 
